...
def fix_currency() -> list:
    ...
    return [
        ...
        },
        {
            ...
            "operationAmount": {"amount": "79114.93", "currency": {"name": "USD", "code": "JPN"}},
...
@pytest.fixture
def fix_tansaction_data() -> list[dict]:
    """Транзакции для теста в формате список словарей"""
    return [
...
@pytest.fixture
def fix_corto_json_result_func() -> list[dict]:
    """ Фикстура для проверки Json"""
    return [{'id': 939719570, 'state': 'EXECUTED',
             'date': '2018-06-30T02:08:58.425572', 'amount': '9824.07',
